function validar(){
    ...
    if(password === ""){
        ...
        $("#mensaje6").text("La contraseña debe tener números y letras")
    }
...
function validarcontra(password){
    return /[a-zA-Z]/.test(contrasena) && /\d/.test(contrasena);
}
...
function validarFormulario() {
    ...
    if (password == "") {
        document.getElementById("mensajecontra").innerHTML = "Campo contraseña no puede estar vacio";
        return false;
    } else {
